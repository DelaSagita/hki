...
class PermohonanController extends Controller
{
    ...
    {
        // $data['list_hakcipta'] = HakCipta::all();
        // return view('admin-cipta.pengajuan.index', $data);

        $data = HakCipta::all();
        return view('admin-cipta.pengajuan.index', compact('data'));

    }
    public function create()
    {
        return view('admin-cipta.pengajuan.create');
    }
    public function store(Request $request)
    {
        ...
        $hakcipta->save();
        return redirect('admin-cipta/pendaftaran-ciptaan');
    }
    ...
    public function show(HakCipta $hakcipta)
    {
        ...
        return view('admin-cipta.pengajuan.show', $data);
    }
}
