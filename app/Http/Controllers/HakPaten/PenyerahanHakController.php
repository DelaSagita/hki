...
class PenyerahanHakController extends Controller
{
    public function index()
    {
        $data['list_paten'] = penyerahan::all();
        return view('hak-paten.penyerahan-hak.index', $data);
    }
    public function create()
    {
        return view('hak-paten.penyerahan-hak.create');
    }
    public function store(Request $request)
    {
        ...
        $hakpaten->save();
        return redirect('hak-paten/penyerahan-hak');
    }
    ...
    {
        $data['paten'] = $paten;
        return view('hak-paten.penyerahan-hak.show', $data);
    }
}
